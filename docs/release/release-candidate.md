...
Checked items below were reproduced through CF056 and are recorded in the
validation baseline; the package/source identity matrix originated on CF051
and the executable MCP evidence was revalidated on CF054. The CF055 and CF056
controlled GPU paths were reproduced separately on the same validated adapter. Pull-request quality
...
- lighting supports independently bounded sets of at most four stable-ordered
  ...
  conversion, occlusion/emissive/alpha textures, additional image
