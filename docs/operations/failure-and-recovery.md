...
| Draw, mesh-upload, or role-texture residency pressure | Reject before GPU preparation/allocation; atomically reserve only missing content-hash-and-role textures | renderer scene and CF029/CF055 asset tests |
